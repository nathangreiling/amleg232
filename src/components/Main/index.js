...
function Main(props) {
  ...
  return (
    <Grid
      ...
      <p className='tab'>"The American Legion is a social and mutual-aid veterans' organization including members of the United States armed forces. 
      ...
      <p className='tab'>"In addition to organizing commemorative events and volunteer veteran support 
      ...
      <p className='tab'> Here at the Longview American Legion, we believe in giving support back to the public. 
